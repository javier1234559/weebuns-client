...
export type GetCorrectionsByEssayQuery = { __typename?: 'Query', getCorrectionsByEssay?: { __typename?: 'CorrectionResponseAllDto', data: Array<{ __typename?: 'CorrectionResponseOneDto', id: string, essayId: string, createdBy: string, overall_comment?: string | null, rating?: number | null, createdAt: any, updatedAt: any, creator?: { __typename?: 'User', id: string, username: string, nativeLanguage: LanguageCode, email: string, role: UserRole, authProvider: AuthProvider, authProviderId?: string | null, firstName?: string | null, lastName?: string | null, profilePicture?: string | null, isEmailVerified: boolean, lastLogin?: any | null, createdAt: any, updatedAt: any } | null, sentences?: Array<{ __typename?: 'CorrectionSentence', id: string, correctionId: string, index: number, originalText: string, correctedText?: string | null, explanation?: string | null, isCorrect: boolean, rating: number, createdAt: any, updatedAt: any }> | null }>, pagination: { __typename?: 'PaginationOutputDto', totalItems: number, currentPage: number, totalPages: number, itemsPerPage: number, hasNextPage: boolean, hasPreviousPage: boolean } } | null };
